  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background-mist font-sans p-6">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <h1 className="font-display font-black text-3xl text-secondary">Verification Error</h1>
        <p className="text-text-slate text-[15px] font-medium">An unexpected error occurred during email verification.</p>
        <button
          onClick={reset}

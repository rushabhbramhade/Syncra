  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [notifRes, countRes, statsRes] = await Promise.all([
        getNotificationsAction(activeUserId, { limit: 100, status: statusMap[filter] }),
        getUnreadCountAction(activeUserId),
        getNotificationStatsAction(activeUserId),
      ]);

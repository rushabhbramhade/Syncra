  ...
  return (
    <div className="flex h-[calc(100vh-64px)] overflow-hidden font-sans text-text-ink relative bg-background-mist theme-transition">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-background-mist">
        ...
        {/* Header bar */}
        <header className="h-16 px-4 border-b-[2px] border-border-mist bg-surface-white flex justify-between items-center z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            {!sidebarOpen && (
              <button 
                ...
                className="p-1.5 hover:bg-border-mist rounded-xl transition-colors cursor-pointer hidden md:block"
            ...
            <button 
              ...
              className="p-2 bg-background-mist rounded-xl border border-border-mist md:hidden cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="py-1.5 px-3 bg-surface-white rounded-xl border-[2px] border-border-mist shadow-sm hover:border-text-slate transition-all duration-200 text-[11px] font-bold flex items-center gap-1.5 cursor-pointer"
              >
              ...
              {modelMenuOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-surface-white rounded-2xl border-[2px] border-border-mist shadow-lg z-30 overflow-hidden">
                  <div className="p-2 border-b border-border-mist">
                  ...
                  <div className="p-1 space-y-0.5">
                    {MODELS.map((model) => (
                      <button
                        ...
                        className={`w-full text-left p-2 rounded-xl transition-colors hover:bg-border-mist flex flex-col cursor-pointer ${
                          activeModel === model.id ? "bg-primary/5 dark:bg-primary/10 border-l-[3px] border-primary" : ""
                        }`}
                      >
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 scrollbar-hide relative">
          ...
          {loadingChat && messages.length === 0 ? (
            ...
            <div className="max-w-3xl mx-auto py-16 md:py-24 text-center space-y-12">
              <div className="flex flex-col items-center gap-5">
                <div className="relative flex items-center justify-center">
                  {/* Outer pulsing soft ring */}
                  <div className="absolute inset-[-12px] bg-primary/5 dark:bg-primary/10 rounded-[32px] blur-xl animate-pulse" />
                  {/* Inner container */}
                  <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-transparent rounded-[28px] border-2 border-primary/30 dark:border-primary/50 flex items-center justify-center shadow-lg">
                    <Bot className="w-10 h-10 text-primary" />
                  </div>
                </div>
                <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-text-ink mt-4">
                  Syncra Workspace Agent
                </h1>
                <p className="text-text-slate text-[16px] max-w-lg mx-auto font-medium leading-relaxed">
                  Your intelligent sidekick for workspace channels. I can check your briefings, write Gmail replies, execute updates on platforms, and perform automated tasks.
                </p>
              </div>

              {/* Suggestions Cards */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left max-w-2xl mx-auto pt-6">
                <button
                ...
                >
                  <FolderSync className="w-6 h-6 text-accent-green mb-3" />
                  <div className="text-[15px] font-black text-text-ink">Summarize Briefings</div>
                  <div className="text-[12.5px] text-text-slate mt-1.5 leading-relaxed">Get a daily rundown and action items from connected networks.</div>
                </button>
                ...
                >
                  ...
                  <div className="text-[15px] font-black text-text-ink">Draft Action Replies</div>
                  <div className="text-[12.5px] text-text-slate mt-1.5 leading-relaxed">Send customized messages or replies through integrations.</div>
                </button>
              </div>
            </div>
          ) : (

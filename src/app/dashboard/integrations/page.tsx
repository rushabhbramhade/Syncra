...
function CountryDropdownPortal({
  ...
  useEffect(() => {
    const updatePosition = () => {
      ...
      // Flip upward if not enough space below and there's more space above
  ...
  }, [setShowCountryDropdown, setCountrySearch]);
  ...
  return (
    ...
    >
      {/* Sticky Search box */}
      <div className="sticky top-0 z-10 bg-white dark:bg-[#0B1120] px-2 pt-2 pb-1.5 border-b border-slate-100 dark:border-slate-800/80 rounded-t-xl">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <ReactCountryFlag countryCode={country.iso} svg style={{ width: '1.5em', height: '1.5em', borderRadius: '2px' }} />
              ...
              {!whatsappPairingCode ? (
                <form onSubmit={handleGenerateWhatsAppPairingCode} className="space-y-6">
                  <div className="space-y-2.5 text-slate-600 dark:text-slate-400">
                    ...
                    <ul className="space-y-1.5 text-[12.5px] font-medium text-slate-500 dark:text-slate-400 list-none pl-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#25D366] shrink-0 mt-0.5">â€¢</span>
                        <span>Include your country code.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#25D366] shrink-0 mt-0.5">â€¢</span>
                        <span>Example: <span className="font-semibold text-slate-755 dark:text-slate-300 font-mono">+1 234 567 8900</span></span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#25D366] shrink-0 mt-0.5">â€¢</span>
                        <span>We&apos;ll generate a secure pairing code.</span>
                      </li>
                    </ul>
                  </div>
